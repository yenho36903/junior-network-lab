...
# 실습 목표
같은 네트워크에서 통신이 가능한 이유를 확인하고,
IP Address와 Subnet Mask가 네트워크를 구분하는 기준임을 이해한다.
## 핵십 개념 
- 같은 네트워크 판단 기준: IP + Subnet Mask
- 스위치는 L2 장비로 같은 네트워크 내 통신만 가능
## 네트워크 구성 
-pc 2대 
-switch 1eo 2960
